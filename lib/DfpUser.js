...
DfpUser.prototype.getService = function (service, callback, version) {
  ...
  oathClient.refreshAccessToken(function (err, tokens) {
    ...
    soap.createClient(soap_wsdl, function (err, client) {
      ...
      client.addSoapHeader(dfpUser.getSOAPHeader(tokens), 'RequestHeader', 'ns1', '');
      ...
      for(var method in interfacePort){
        ...
        if (object && typeof(object) == "function") {
          serviceInstance[method] = (function(method) {
              return function() {
                var options = { 'Authorization' : tokens.token_type + ' ' + tokens.access_token };
                client[method](arguments[0], arguments[1], arguments[2], options, arguments[3], arguments[4], arguments[5], arguments[6], arguments[7]);
              };
          })(method);
        }
      }
